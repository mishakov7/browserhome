...
const Todo = (props: any) => {
    ...
    // const [{ trashHandler }, dump] = useDrop<
    //     DragItem, 
    //     void,
    //     { trashHandler: Identifier | null }
    // >({
    //     accept: 'todo',
    //     dump: () => ({ name: "trashcan" }),
    //     collect: (monitor) => ({
    ...
    //         console.log("dragging on the way to the trash");
    //     },
    //     drop(item: DragItem, monitor) {
    //         console.log("item dumped in trash!" + item.idx);
    //     }
    // });
    ...
    const [{ isDragging }, drag] = useDrag({
        ...
        collect: (monitor: any) => ({
            ...
            if (monitor.getDropResult().name == "trashcan") {
                console.log("throwing out todo #" + item.idx);
    ...
    // useEffect(() => {
    //     if (props.trashRef) {
    //         props.trashRef.setAttribute('ref', trashHandler);
    //     }
