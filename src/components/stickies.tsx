    ...
    <div className='stickies-wrapper'>
        ...
        <div className='date accent1-bg'>
            ...
            <div className='buttons-container'>
                ...
                {/* Create Note */}
                <button /*onClick={}*/ className='note-button'>
