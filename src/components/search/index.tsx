...
export default function Search(props: any) {
  ...
  const changeSearch = (e: any) => {
    ...
    props.setTutorial(props.steps + 1);
  ...
  return (
    ...
    <div ref={props.parentRef} className='search-container'>
        ...
        <div className="inputGroup">
          ...
          <a target="_blank" onClick={() => props.setTutorial(props.steps + 1)} onMouseOver={() => { if (search == "") { setSearch(quoteSearch) }}} href={searchEngine + search}>
