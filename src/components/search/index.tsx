...
export default function Search(props: any) {
  ...
  const searchAnchor = useRef<HTMLAnchorElement>(null);
  ...
  return (
    ...
    <div ref={props.parentRef} className='search-container'>
        ...
        <div className="inputGroup">
          ...
          <a ref={searchAnchor} href={searchEngine + search} className="hotspot" target="_blank" onClick={(e: any) => openBackgroundTab(e) } onMouseOver={() => { if (search == "") { setSearch(quoteSearch) }}}>
            <svg className='accent1-fill' width="25" height="25" viewBox="0 0 31 32" fill="none" xmlns="http://www.w3.org/2000/svg">
